#-------------------------------------------------------------------
#
#   $Id: 16_test_cache.t,v 1.2 2008-06-17 11:31:43 erwan_lemonnier Exp $
#
...
ok($@ =~ /cannot memoize result when input arguments contain references/, "contract fail if args contain references");
